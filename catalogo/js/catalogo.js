(function(){
  ...
  function unlockAdmin(){
    const pin = prompt("PIN de sistema admin");
  ...
  function addExtraProduct(source){
    ...
    if(!name || !presentation || price == null){
      alert("Completa nombre, presentacion y precio del producto extra.");
      return;
    }
    ...
    state.quote[code] = (state.quote[code] || 0) + 1;
  ...
  function bind(){
    ...
    $("#adminAccessMobile").addEventListener("click", unlockAdmin);
    $("#adminAccessDesktop").addEventListener("click", unlockAdmin);
